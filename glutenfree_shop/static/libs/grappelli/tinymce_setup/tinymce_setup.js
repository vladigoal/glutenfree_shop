...
tinyMCE.init({
    ...
    // Init
    mode: 'exact',
    elements : "id_description, id_ingredients, id_cooking, id_content",
    theme: 'advanced',
    skin: 'grappelli',
...
//    theme_advanced_buttons2: 'search,|,pasteword,template,media,charmap,|,code,|,table,cleanup,grappelli_documentstructure',
    theme_advanced_buttons1: 'bold,italic,underline,|,bullist,numlist,blockquote,|,undo,redo,|,link,unlink,|,grappelli_adv',
    theme_advanced_buttons2: 'charmap,|,code,|,table,cleanup,grappelli_documentstructure',
