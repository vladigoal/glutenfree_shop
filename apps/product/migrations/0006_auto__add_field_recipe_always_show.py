...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipe.always_show'
        db.add_column(u'product_recipe', 'always_show',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipe.always_show'
        db.delete_column(u'product_recipe', 'always_show')
