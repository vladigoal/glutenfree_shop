...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'product_product', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product.Category']),
                      keep_default=False)

        # Adding field 'Product.brand'
        db.add_column(u'product_product', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product.Brand']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'product_product', 'brand_id')
