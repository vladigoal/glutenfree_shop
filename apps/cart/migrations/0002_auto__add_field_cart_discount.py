...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cart_cart', 'discount',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'cart_cart', 'discount')
    ...
    models = {
        ...
        u'cart.cart': {
            ...
            'tm_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 18, 0, 0)', 'null': 'True'}),
